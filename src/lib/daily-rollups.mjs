  ...
  for (const key of allKeys) {
    ...
    for (const inst of gaInstancesRaw) {
      ...
      sessions: {
        ...
        cs_select_sessions: s.cs_select_sessions || 0,
        cs_user_sessions: s.cs_user_sessions || 0,
        cs_cred_sessions: s.cs_cred_sessions || 0,
        cs_select_views: s.cs_select_views || 0,
        cs_user_views: s.cs_user_views || 0,
        cs_cred_views: s.cs_cred_views || 0,
      },
      placements: p,
    };
  }
